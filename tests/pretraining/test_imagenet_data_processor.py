...
def fixture_raw_features_and_labels() -> tuple[
...
def test_get_raw_features_and_labels_valid_labels(
    ...
    class_designators = {
        designator_and_name[0] for designator_and_name in class_index.values()
    }
